...
public class QuickSortDriver 
{
    public static void main(String[] args)
    {
        ...
        qs.sort(array_1000, 0, array_100.length-1);
        ...
        qs.sort(array_5000, 0, array_100.length-1);
        ...
        qs.sort(array_10000, 0, array_100.length-1);
        ...
        qs.sort(array_50000, 0, array_100.length-1);
        ...
        qs.sort(array_100000, 0, array_100.length-1);
        ...
        qs.sort(array_500000, 0, array_100.length-1);
