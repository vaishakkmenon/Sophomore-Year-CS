...
{
   private final static int TABLE_1 = 100;
   private final static int TABLE_2 = 1000;
   private final static int TABLE_3 = 2000;
   private final static int TABLE_4 = 4000;
   private final static int TABLE_5 = 8000;
   ...
   public String get(double key, int choice) 
   {
      ...
      switch(choice)
      {
         ...
         {
            value = table2[index].toString();
         }
   
         originalIndex = index;
         while(table2[index].getKey() != key)
         {
